...
RUN wget -O -  https://repo.saltproject.io/py3/ubuntu/18.04/amd64/archive/3004.2/SALTSTACK-GPG-KEY.pub | apt-key add -
RUN echo deb  https://repo.saltproject.io/py3/ubuntu/18.04/amd64/archive/3004.2 bionic main >> /etc/apt/sources.list.d/saltstack.list
RUN apt-get update
